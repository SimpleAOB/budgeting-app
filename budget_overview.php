<script>
	...
	function buildPage() {
		...
		for (var key in ls[3]["income_rows"]) {
			document.getElementById("income-table").innerHTML += "<tr data-irow=\"" + key + "\"><td><input type=\"text\" data-irow=\"" 
			+ key + "\" name=\"name\" value=\"" + ls[3]["income_rows"][key]["row_name"] + "\" onblur=\"editRow(this)\"></td><td><input type=\"text\" data-irow=\"" 
			+ key + "\" name=\"val\" value=\"" + ls[3]["income_rows"][key]["row_value"] + "\" onblur=\"editRow(this)\"></td><td><button onclick=\"removeIncomeRow(this)\" data-irow=\"" 
			+ key + "\">Delete</button></td></tr>";
		}
		for (var key in ls[4]["expense_rows"]) {
			document.getElementById("expense-table").innerHTML += "<tr data-erow=\"" + key + "\"><td><input type=\"text\" data-erow=\"" 
			+ key + "\" name=\"name\" value=\"" + ls[4]["expense_rows"][key]["row_name"] + "\" onblur=\"editRow(this)\"></td><td><input type=\"text\" data-erow=\"" 
			+ key + "\" name=\"val\" value=\"" + ls[4]["expense_rows"][key]["row_value"] + "\" onblur=\"editRow(this)\"></td><td><button onclick=\"removeExpenseRow(this)\" data-erow=\"" 
			+ key + "\">Delete</button><td/></tr>";
		}
	}
	</script>
